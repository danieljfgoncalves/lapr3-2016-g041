...
public class MapGraphTest {
     ...
     * Test instance
     */
    private MapGraph<String, String> instance;
    ...
    public void testEdges() {
        ...
        Iterator<MapEdge<String, String>> itEdge = instance.edges().iterator();
    ...
    public void testEndVertices() {
        ...
        MapEdge<String, String> edge0 = new MapEdge<>();

        String[] vertices = new String[2];

        //assertTrue("endVertices should be null", instance.endVertices(edge0)==null);
        MapEdge<String, String> edge1 = instance.getEdge("A", "B");
    ...
    public void testOpposite() {
        ...
        MapEdge<String, String> edge5 = instance.getEdge("C", "E");
        ...
        MapEdge<String, String> edge8 = instance.getEdge("E", "E");
    ...
    public void testOutgoingEdges() {
        ...
        Iterator<MapEdge<String, String>> itEdge = instance.outgoingEdges("C").iterator();
        MapEdge<String, String> first = itEdge.next();
        MapEdge<String, String> second = itEdge.next();
    ...
    public void testIncomingEdges() {
        ...
        Iterator<MapEdge<String, String>> itEdge = instance.incomingEdges("D").iterator();
    ...
    public void testInsertEdge() {
        ...
        Iterator<MapEdge<String, String>> itEd = instance.edges().iterator();
    ...
    public void testClone() throws CloneNotSupportedException {
        ...
        //and edges also
        Iterator<MapEdge<String, String>> itedgeSource = instance.edges().iterator();
        while (itedgeSource.hasNext()) {
            Iterator<MapEdge<String, String>> itedgeClone = instClone.edges().iterator();
