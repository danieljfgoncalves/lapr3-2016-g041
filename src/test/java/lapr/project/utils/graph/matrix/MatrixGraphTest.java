...
public class MatrixGraphTest {
    ...
    public void testNumVertices() {
        ...
        MatrixGraph<Integer, Integer> instance = new MatrixGraph<>();
    ...
    public void testVertices() {
        ...
        Iterator<Integer> itVert = instance.vertices().iterator();
        ...
        assertTrue("first vertice should be \"Vert 1\"", (itVert.next().compareTo(1) == 0));
        assertTrue("second vertice should be \"Vert 2\"", (itVert.next().compareTo(2) == 0));

        instance.removeVertex(1);

        itVert = instance.vertices().iterator();
        assertTrue("first vertice should now be \"Vert 2\"", (itVert.next().compareTo(2) == 0));
        ...
        assertTrue("iterator should still give \"Vert 1\" (no change in cloned obj)", (itVert.next().compareTo(1) == 0));
    ...
    public void testOutDegree02() {
        ...
        assertTrue("out degree should be 3", (instance.outDegree("Vert 2") == 2));

        instance.removeEdge("Vert 2", "Vert 4");

        assertTrue("out degree should be 2", (instance.outDegree("Vert 2") == 1));
    ...
    public void testInDegree02() {
        ...
        assertTrue("in degree should be 3", (instance.inDegree("Vert 3") == 2));

        instance.removeEdge("Vert 1", "Vert 3");
        assertTrue("in degree should be 2", (instance.inDegree("Vert 3") == 1));
    ...
    public void testDirectConnections01() {
        ...
        instance.removeEdge("Vert 3", "Vert 1");

        itVertex = instance.directConnections("Vert 1").iterator();
        assertTrue("first vertex should now be \"Vert 2\"", (itVertex.next().compareTo("Vert 2") == 0));
    ...
    public void testOutgoingEdges01() {
        ...
        itEdge = instance.outgoingEdges("Vert 1").iterator();
        assertTrue("first edge should now be \"Edge 1\"", (itEdge.next().compareTo("Edge 1") == 0));
    ...
    public void testIncomingEdges01() {
        ...
        itEdge = instance.incomingEdges("Vert 3").iterator();
        assertTrue("first edge should be \"Edge 5\"", (itEdge.next().compareTo("Edge 5") == 0));
        assertTrue("second edge should be \"Edge 4\"", (itEdge.next().compareTo("Edge 4") == 0));
        assertTrue("thrid edge should be \"Edge 3\"", (itEdge.next().compareTo("Edge 3") == 0));

        instance.removeEdge("Vert 1", "Vert 3");

        itEdge = instance.incomingEdges("Vert 3").iterator();
        assertTrue("first edge should now be \"Edge 4\"", (itEdge.next().compareTo("Edge 4") == 0));
        assertTrue("second edge should be \"Edge 3\"", (itEdge.next().compareTo("Edge 3") == 0));
    ...
    public void testIncomingEdges02() {
        ...
        assertTrue("first edge should be \"Edge 4\"", (itEdge.next().compareTo("Edge 5") == 0));
        assertTrue("second edge should be \"Edge 5\"", (itEdge.next().compareTo("Edge 4") == 0));

        instance.removeEdge("Vert 1", "Vert 3");

        itEdge = instance.incomingEdges("Vert 3").iterator();
        assertTrue("first edge should now be \"Edge 5\"", (itEdge.next().compareTo("Edge 4") == 0));
    ...
    public void testGetEdge01() {
        ...
        assertTrue("edge should be \"Edge 2\"", instance.getEdge("Vert 2", "Vert 4").compareTo("Edge 2") == 0);

        instance.removeEdge("Vert 2", "Vert 4");

        assertTrue("edge should be null", instance.getEdge("Vert 2", "Vert 5") == null);
        instance.insertEdge("Vert 2", "Vert 4", "Edge 6");
        assertTrue("edge should be \"Edge 6\"", instance.getEdge("Vert 2", "Vert 4").compareTo("Edge 6") == 0);
    }
    ...
    public void testGetEdge02() {
        ...
        assertTrue("edge should be null", instance.getEdge("Vert 4", "Vert 2") == null);
    ...
    public void testEndVertices02() {
        ...
        endVertices = instance.endVertices("Edge 3");

        String v1 = (String) endVertices[0];
        String v2 = (String) endVertices[1];

        assertTrue("first vertex should be \"Vert 1\"", v1.compareTo("Vert 1") == 0);
        assertTrue("second vertex should be \"Vert 5\"", v2.compareTo("Vert 5") == 0);
    }
    ...
    public void testInsertEdge02() {
        ...
        instance.insertEdge("Vert 2", "Vert 1", "Edge 2");
        assertTrue("result should be two", (instance.numEdges() == 2));
    ...
    public void testRemoveEdge02() {
        ...
        instance.insertEdge("Vert 2", "Vert 4", "Edge 3");
        assertTrue("result should be two", (instance.numEdges() == 3));

        Iterator<String> itEdge = instance.edges().iterator();

        assertTrue("first edge should be \"Edge 1\"", (itEdge.next().compareTo("Edge 1") == 0));
        assertTrue("second edge should be \"Edge 2\"", (itEdge.next().compareTo("Edge 2") == 0));
