...
public class AirportsRegisterTest {
    ...
    public void testGetSetAirports() {
        ...
        List<Airport> airports = new ArrayList<>();
        airports.add(new Airport("Francisco Sá Carneiro", "Porto", "Portugal", "OPO", new Coordinate("id1", 1.0d, 1.1d), Amount.valueOf(100.0d, SI.METER)));
    ...
    //TODO: testImportXml when the new method to import is made
}
